...
python3 incremental_pca.py $k --batch-size=100 --kfold=5 --pngdir=output4all_cgn_10000/$kk._mbn_$i.$j.$l.$m.$ms --prmc=0.01 --uselayer=$j --seed=$l --useparam=$m --mul_sig=$ms --judge --clear_gn --n_images=10000
