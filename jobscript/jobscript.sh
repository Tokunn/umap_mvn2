...
python3 incremental_pca.py $k --batch-size=100 --kfold=1 --pngdir=output4all/$kk._mbn_$i.$j.$l.$m --prmc=1 --uselayer=$j --seed=$l --useparam=$m
# python3 incremental_pca.py $k --batch-size=100 --kfold=4 --pngdir=output4all_kfold/$kk._mbn_$i.$l --prmc=1 --seed=$l
