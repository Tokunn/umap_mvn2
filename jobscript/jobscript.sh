...
python3 incremental_pca.py $k --batch-size=100 --kfold=5 --pngdir=output4all_cgn_updthre5_reject_defgmix_10forfull_check/$kk._mbn_$i.$j.$l.$m.$ms --prmc=$i --uselayer=$j --seed=$l --useparam=$m --mul_sig=$ms --judge --usereject --clear_gn --updgooddef --defgmix
# python3 incremental_pca.py $k --batch-size=100 --kfold=5 --pngdir=output4all_cgn_concat3_1/$kk._mbn_$i.$j.$l.$m.$ms --prmc=0.01 --uselayer=$j --seed=$l --useparam=$m --mul_sig=$ms --judge --clear_gn --concat
...
#
#
# python3 incremental_pca.py $k --batch-size=100 --kfold=5 --pngdir=output4all_cgn_updthre5_reject_defgmix/$kk._mbn_$i.$j.$l.$m.$ms --prmc=0.01 --uselayer=$j --seed=$l --useparam=$m --mul_sig=$ms --judge --usereject --clear_gn --updgooddef --defgmix
